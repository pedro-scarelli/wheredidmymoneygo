...
type CreateMovementRequestDTO struct {
	Value       float64           `json:"value"`
	Type        enum.MovementType `json:"type"`
	Occurrences int               `json:"occurrence"`
}

func (d *CreateMovementRequestDTO) Validate() error {
	switch d.Type {
...
func FromJSONCreateMovementRequestDTO(body io.Reader) (*CreateMovementRequestDTO, error) {
	createMovementRequestDTO := CreateMovementRequestDTO{}
